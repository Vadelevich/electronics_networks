...
from electronics.serializers import SupplierSerializerCreate, SupplierSerializer, ContactSerializer, ProductSerializer, \
    SupplierSerializerUpdate
...
class SuppliersContactUpdateAPIView(UpdateAPIView):
    queryset = Contact.objects.all()
    serializer_class = ContactSerializer
    permission_classes = [IsAuthenticated, IsActive]


class SuppliersProductUpdateAPIView(UpdateAPIView):
